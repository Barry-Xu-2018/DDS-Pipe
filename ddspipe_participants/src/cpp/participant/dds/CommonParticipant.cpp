        ...
        const core::ITopic& topic)
{
    ...
    {
#if 0
        std::cerr << "Not creating Writer for non RTPS topic " << dds_topic.topic_name() << std::endl;
        ...
        const core::ITopic& topic)
{
    ...
    {
#if 0
        std::cerr << "Not creating Reader for non RTPS topic " << dds_topic.topic_name() << std::endl;
